...
-o namd.out -e namd.err ../run_base_train_llvmtuner17.0.6.0000/namd_r_base.llvmtuner17.0.6 --input apoa1.input --iterations 7 --output apoa1.train.output > namd.out 2>> namd.err
