...
-o diffmail.2.550.15.24.23.100.out -e diffmail.2.550.15.24.23.100.err ../run_base_train_llvmtuner17.0.6.0000/perlbench_r_base.llvmtuner17.0.6 -I./lib diffmail.pl 2 550 15 24 23 100 > diffmail.2.550.15.24.23.100.out 2>> diffmail.2.550.15.24.23.100.err
-o perfect.b.3.out -e perfect.b.3.err ../run_base_train_llvmtuner17.0.6.0000/perlbench_r_base.llvmtuner17.0.6 -I./lib perfect.pl b 3 > perfect.b.3.out 2>> perfect.b.3.err
-i scrabbl.in -o scrabbl.out -e scrabbl.err ../run_base_train_llvmtuner17.0.6.0000/perlbench_r_base.llvmtuner17.0.6 -I. -I./lib scrabbl.pl < scrabbl.in > scrabbl.out 2>> scrabbl.err
-o splitmail.535.13.25.24.1091.1.out -e splitmail.535.13.25.24.1091.1.err ../run_base_train_llvmtuner17.0.6.0000/perlbench_r_base.llvmtuner17.0.6 -I./lib splitmail.pl 535 13 25 24 1091 1 > splitmail.535.13.25.24.1091.1.out 2>> splitmail.535.13.25.24.1091.1.err
-o suns.out -e suns.err ../run_base_train_llvmtuner17.0.6.0000/perlbench_r_base.llvmtuner17.0.6 -I. -I./lib suns.pl > suns.out 2>> suns.err
