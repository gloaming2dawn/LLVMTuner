...
multimodule_benchmarks = ['automotive_bitcount', 'automotive_qsort1', 'bzip2d', 'bzip2e', 'consumer_jpeg_c', 'consumer_jpeg_d', 'consumer_lame', 'consumer_tiff2bw', 'consumer_tiff2rgba', 'consumer_tiffdither', 'security_blowfish_d', 'security_blowfish_e', 'security_sha', 'telecom_gsm']
# [x for x in all_benchmarks if x not in multimodule_benchmarks]
singlemodule_benchmarks = ['automotive_susan_c', 'automotive_susan_e', 'automotive_susan_s', 'consumer_tiffmedian', 'network_patricia', 'office_stringsearch1', 'security_rijndael_d', 'security_rijndael_e', 'telecom_CRC32', 'telecom_adpcm_c', 'telecom_adpcm_d']
...
for i in range(epochs):
    for method in methods:
        ...
        print(f'time of epoch {i} {method} budget {budget}:',time.time()-t0)
